...
const TeamCard = ({data}) => {
  ...
  return (
    <div>
        ...
        <div className="card-avatar"> <ImageSpinner src={imageURL+data.image}  className='card-avatar'  alt={data.facebook} /></div>
        <div className="card-title">{data.first_name +" " +data.last_name}</div>
        <div className="card-subtitle">{data.role}</div>
        </div>
